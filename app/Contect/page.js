...
export default function Contact(){
  ...
  // const [price, setPrice] = useState('20.00'); // Default price
  // const cost = useRef();
  ...
  //   script.onload = () => {
  //     renderPayPalButton(price); // Render button after script is loaded
  //   };
  ...
  // useEffect(() => {
  //   if (window.paypal) {
  //     renderPayPalButton(price); // Update button with the current price
  //   }
  // }, [price]); // Update PayPal button whenever price changes

  // const saveData = () => {
  //   const selectedCourse = cost.current.value;

  //   if (selectedCourse === 'All Quran Course') {
  //     setPrice('30.00');
  //   } else if (selectedCourse === 'Hafza Quran') {
  //     setPrice('50.00');
  //   } else if (selectedCourse === 'Quran with tafseer') {
  //     setPrice('50.00');
  //   }
  // };

  // const renderPayPalButton = (price) => {
  //   if (window.paypal) {
  //     // Remove existing PayPal button if it exists
  //     const existingButton = document.querySelector('#paypal-button-container');
  //     if (existingButton) {
  ...
  //   const stripe = await  loadStripe("pk_test_51PycwuP0ebickvSnk2QWol9dU5s4BDsNkiUYF5KjoUnNgjcazHmbLTVz1T97SFNm14rRhFRgyeOL37J3yddbj66X00di2vs6Gq")
  //   const { error } = await stripe.redirectToCheckout({
  //     mode: "payment",
  //     lineItems: [{ price: "price_1Pzb0rP0ebickvSnOAPye4X2", quantity: 1 }],
